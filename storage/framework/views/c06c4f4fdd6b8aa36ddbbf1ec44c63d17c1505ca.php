  ...
  <body>
    ...
    <body>
     <font size="5">Silahkan Kirimkan Pesan Kepada Saya</font><br>
        <form class="form-horizontal" method="POST" action="<?php echo e(url('/proses-form')); ?>">
        <?php echo csrf_field(); ?>
...
<?php /**PATH D:\KERJA CERDAS\2021\Order 34\projekuts\resources\views/contact.blade.php ENDPATH**/ ?>