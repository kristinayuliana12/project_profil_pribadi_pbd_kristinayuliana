        ...
        <h3>Hobby Saya</h3>
            <ul class="flex_box">
                ...
                <img src="img/baca.jpg">
                    <h4>Belajar</h4>
                    <p>Belajar adalah salah satu kewajiban dan hobi saya sebagau Mahasiswa</p>
                </li>
                <li>
                <img src="img/masak.jpg">
                    <h4>Memasak</h4>
                    <p>Memasak adalah hobi dan moodbooste bagi saya</p>
                </li>
                <li>
        ...
        <div class="educations">
            ...
            <div class="educations">
                ...
                <table class="table table-striped mt-4">
                    ...
                    <tbody>
                        <?php $__empty_1 = true; $__currentLoopData = $komentarses; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $komentar): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <tr>
                            <th><?php echo e($loop->iteration); ?></th>
                            <td><?php echo e($komentar->nama); ?></td>
                            <td><?php echo e($komentar->coment); ?></td>
                            <td><?php echo e($komentar->created_at); ?></td>
                        </tr>
...
</html><?php /**PATH D:\KERJA CERDAS\2021\Order 34\projekuts\resources\views/profil.blade.php ENDPATH**/ ?>